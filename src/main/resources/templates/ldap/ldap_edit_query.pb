    ...
    width: 100%;">
        <div style="padding: 30px !important;">
            ...
            <form method="post" id="epcreateForm">
                ...
                <input type="hidden" value="{{ endpoint.id }}" name="op" id="op">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" required name="ename" id="ename" value="{{ endpoint.endPointName }}"
                               class="form-control"/>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <select name="connName" id="connName" required class="form-control">
                            ...
                            {% for account in accounts %}
                                {% if account.id == endpoint.ldapAccounts.id %}
                                    <option title="{{ account.id }}"
                                            value="{{ account.connName }}"
                                            selected>{{ account.connName }}</option>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="base" id="base" value="{{ endpoint.base }}" required
                               class="form-control"/>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control" id="query" required name="query"
                                  rows="8">{{ endpoint.query }}</textarea>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control" id="rf" name="rf"
                                  rows="5">{{ endpoint.requiredFields }}</textarea>
                    </div>
                </div>
