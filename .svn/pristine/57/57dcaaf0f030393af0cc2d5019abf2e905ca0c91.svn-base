        ...
        <form method="post" action="{{ request.contextPath }}/ldap/create" id="ldapAccountCreateForm">
            <div style="border:1px; background:#ECF0F1;padding:30px;">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="host" id="host" class="form-control" value="{{ ldapaccount.host }}"
                               required>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="pretext" id="pretext" class="form-control"  value="{{ ldapaccount.pretext }}">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="posttext" id="posttext" class="form-control" value="{{ ldapaccount.posttext }}">
                    </div>
                </div>
