...
public class ActiveMQBase implements BaseModel {
    ...
    public void indexerUpdate(IndexerDomain indexerDomain) {
        try {
            ...
            indexerDomain = IndexerUtilities.findByNameAndStatussk(SFInterfaceConnectionBase.fetchJdbcTemplatebyType(user, SFInterfaceConstants.getDbRefConnectionName()), indexerDomain.getName());
