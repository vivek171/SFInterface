        ...
        <div style="border:1px; background:#ECF0F1;padding:30px;">
            <form method="post" id="editForm" class="form">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" id="endpointname" for="endpointname" name="endpointName"
                               required>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control" id="endpointdesc" name="endpointdesc"></textarea>
                    </div>
                </div>
                ...
                <div class="row form-group" style="display:none;">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" id="endpointurl" name="endpointurl" value="{{ uid }}"
                               disabled required>
                ...
                <div style="color:white" !important>
                    <div id="jsGrid" class="row form-group">
                    </div>
                </div>
                ...
                <div class="center-block text-center">
                    <div class="row form-group">
                        ...
                        <button type="submit" value="submit" id="submit" class="btn btn-primary"
                                style="background-color:#0ea3c4 ;margin-right:13;width:100">Save
                        </button>
                        <button type="button" value="Reset" id="reset" class="btn btn-primary"
                                style="background-color:#0ea3c4;margin-right:13;width:100">Reset
                        </button>
                        <button type="button" value="preview" id="preview" class="btn btn-primary"
                                style="background-color:#0ea3c4;width:100">Preview
                        </button>
                    </div>
                </div>
...
{% block script %}
    <script type="text/javascript" src="{{ request.contextPath }}/static/js/select2_min.js" defer></script>
    <script type="text/javascript" src="{{ request.contextPath }}/static/js/custom/query.js"></script>
    <style>
